...
<head>
    ...
    <script type="text/javascript">
    	...
    	function getPagerUrl() {
        	var pagerUrl = "link/pushLinkHisServlet?1=1";
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-weight: bold">
								<c:choose>
								<c:when test="${pushLink.linkType == 0 }">Website</c:when>
								<c:when test="${pushLink.linkType == 1 }">BookMark</c:when>
								<c:when test="${pushLink.linkType == 2 }">Notification</c:when>
                        ...
                        <tr>
                            ...
                            <td style="font-weight: bold">
                            <img id="showIcon" src="${pageContext.request.contextPath}/${pushLink.icon}" height="48px" width="48px"/>
                            </td>   
                        </tr>
                        <tr>
                            <th scope="row">Url：</th>
                            <td style="font-weight: bold">${pushLink.url }</td>    
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="font-weight: bold">
                            <c:choose>
                                <c:when test="${empty pushLink.countClicked }">
                                	0
                                </c:when>
                                <c:otherwise>
                                  ${pushLink.countClicked }
                                </c:otherwise>
                                </c:choose>
                            </td>    
                        </tr>
