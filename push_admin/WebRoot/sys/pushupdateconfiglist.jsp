...
<head>
    ...
    <script type="text/javascript">
        ...
        function getPagerUrl() {
        	var pagerUrl = "sys/pushUpdateConfigServlet?1=1";
            pagerUrl += "&countryName="+
		...
		$(function() {
			$("#search").click(function() {
            	...
            	url = J.FormatString(url + '?countryName={0}&countryAddr={1}&pageSize={2}', encodeURI(encodeURI(countryName)),encodeURI(encodeURI(countryAddr)), pageSize);
            	Index.Open(url);
			});
...
<body>
<div class="container">
    <div class="location">Current Location：Update Config -&gt;Update Config</div>
    ...
    <div class="block">
        <div class="h">
            ...
            <h3>Update Config List</h3>
            <div class="bar" style="display: block;">
                <a class="btn-lit" href="javascript:Index.Open('sys/pushUpdateConfigServlet?operation=other&pageCount=${pagerInfo.pageCount }');"><span>Add</span></a>
                ...
                <table class="data-table" width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                        <tr>
                            ...
                            <th scope="col">Count Upgraded</th>
                        ...
                        <tr>
			              ...
			              <td class="txt100 c">
			              	<a href="javascript:Index.Open('sys/pushUpdateConfigHisServlet?pushId=${userinfo.id }');" title="Detail">
			              		${userinfo.title }
			              	</a>	
			              </td>
			              <td class="txt c">${userinfo.timeOut } 秒</td>
			              <td class="txt100 c">${userinfo.countSended }</td>
			              <td class="txt100 c">${userinfo.countUpgraded }</td>
			              <td class="txt100 c">${userinfo.countSended + userinfo.countUpgraded }</td>
			              <td class="txt140 c">${userinfo.pushDate }</td>
			              <td class="icon">
			              <c:if test="${userinfo.canEdit }">
			              <a class="opt" title="Modify" href="javascript:Index.Open('sys/pushUpdateConfigServlet?operation=other&'+J.getParam('${userinfo }'));"><span class="icon-sprite icon-edit"></span></a>
			              </c:if>
			              </td>
                          <td class="icon tail">
                          <!-- 
