...
<head>
    ...
    <script type="text/javascript">
        ...
        function getPagerUrl() {
        	var pagerUrl = "text/pushTextServlet?1=1";
                ...
                if (v == 'ok') {
                    Login.Tip('precessing...', 'loading');
 					...
 					$.ajax({
				           cache:true,
				           type: "POST",
				           url:"${pageContext.request.contextPath}/text/pushTextServlet",
...
<body>
<div class="container">
    <div class="location">Current Location：Text Push -&gt;Text Push</div>
    ...
    <div class="block">
        <div class="h">
            ...
            <h3>Push Text List</h3>
            <div class="bar" style="display: block;">
                <a class="btn-lit" href="javascript:Index.Open('text/pushTextServlet?operation=other&pageCount=${pagerInfo.pageCount }');"><span>Add</span></a>
                ...
                <table class="data-table" width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                        ...
                        <tr>
			              ...
			              <td class="txt100 c">
			              	<a href="javascript:Index.Open('text/pushTextHisServlet?pushId=${userinfo.id }');" title="Detail">
			              		${userinfo.title }
			              	</a>	
			              </td>
			              ...
			              <td class="icon">
			              <c:if test="${userinfo.canEdit }">
			              <a class="opt" title="Modify" href="javascript:Index.Open('text/pushTextServlet?operation=other&'+J.getParam('${userinfo }'));"><span class="icon-sprite icon-edit"></span></a>
			              </c:if>
			              </td>
                          <td class="icon tail">
                          <!-- 
