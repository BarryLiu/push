                ...
                <table class="data-form" cellspacing="0" cellpadding="0">
                    <tbody>
                    	<tr>
                            ...
                            <td style="font-weight: bold">${pushText.title }</td>                            
                        </tr>
                        <tr>
                            <th scope="row">Comments：</th>
                            <td style="font-weight: bold">${pushText.comments }</td>               
                        </tr>
                        <tr>
                            <th scope="row">Icon：</th>
                            <td style="font-weight: bold">
                            <img id="showIcon" src="${pageContext.request.contextPath}/${pushText.icon}" height="72px" width="72px"/>
                            </td>    
                        </tr>
                        <tr>
                            <th scope="row">Imei：</th>
                            <td style="font-weight: bold">${pushText.imei1}~${pushText.imei2}</td>
                        </tr>
                        <tr>
                            <th scope="row">Country Name：</th>
                            <td style="font-weight: bold">${pushText.countryName }</td>    
                        </tr>
                        <tr>
                            <th scope="row">Project Name：</th>
                            <td style="font-weight: bold">${pushText.projectName }</td>    
                        </tr>
                        <tr>
                            <th scope="row">Customer Name：</th>
                            <td style="font-weight: bold">${pushText.customerName }</td>    
                        </tr>
                        <tr>
                            <th scope="row">Model Name：</th>
                            <td style="font-weight: bold">${pushText.modelName }</td>    
                        </tr>
                        <tr>
                            <th scope="row">Version Name：</th>
                            <td style="font-weight: bold">${pushText.versionName }</td>    
                        </tr>
                        <tr>
                            <th scope="row">Push Date：</th>
                            <td style="font-weight: bold">${pushText.pushDate }</td> 
                            <th scope="row">Update Date：</th>
                            <td style="font-weight: bold">${pushText.updateDate }</td>       
                        </tr>
                        <tr>
                            <th scope="row">Count Sended：</th>
                            <td style="font-weight: bold">
                            <c:choose>
                                <c:when test="${empty pushText.countSended }">
                                	0
                                </c:when>
                                <c:otherwise>
                                  ${pushText.countSended }
                                </c:otherwise>
                                </c:choose>
                            </td>    
                            ...
                            <td style="font-weight: bold">
                            <c:choose>
                                <c:when test="${empty pushText.countClicked }">
                                	0
                                </c:when>
                                <c:otherwise>
                                  ${pushText.countClicked }
                                </c:otherwise>
                                </c:choose>
                            </td>   
                        </tr>
                        ...
                        <tr>
                            ...
                            <td valign="top" style="font-weight: bold;word-wrap:break-word;">${pushText.updateComments }</td>  
                        </tr>
                         -->
                    </tbody>
                </table>
