...
Calendar.dayMouseOver = function(ev) {
	...
	if (el.ttip) {
		if (el.ttip.substr(0, 1) == "_") {
			...
			el.ttip =  Calendar._YYN[3]+date.print("D")+"  " +date.print("y")+ Calendar._YYN[0]+" "+date.print("M")+" "+date.print("d") +Calendar._YYN[2];
		}
...
//	this.title.firstChild.data = year + "��" + Calendar._MN[month];
	this.title.firstChild.data = year + Calendar._YYN[0];
