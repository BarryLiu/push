...
function Calendar(beginYear, endYear, lang, dateFormatStyle) {
  ...
  "sel_bg"        : "#FFCCCC",  //�ѱ�ѡ������ڵ�Ԫ��Ӱɫ 2006-12-03 www.ttkc.net���  
  "sun_word"      : "#FF0000",  //������������ɫ  
  "sat_word"      : "#0000FF",  //������������ɫ  
...
Calendar.prototype.draw = function() {
  ...
  var mvAry = [];
  //mvAry[mvAry.length]  = '  <form name="calendarForm" style="margin: 0px;">'; //�� <form> ����Ƕ�ף� 2006-12-01 ��www.ttkc.net���� Div
...
//2009-03-03 ��ӵĴ��룬����ʱ�����
  ...
  { calendar.ReturnDate(""); /*calendar.dateControl.value = "";calendar.hide();*///2007-09-14 ��www.ttkc.netע��
  }
...
Calendar.prototype.changeSelect = function() {
  var cy = this.calendarYear;//2006-12-01 ��www.ttkc.net�޸�
  var cm = this.calendarMonth;
  var ch = this.calendarHour;
  var cM = this.calendarMinute;
  var cs = this.calendarSecond;
...
Calendar.prototype.update = function (e){
  this.year  = e.calendarYear.options[e.calendarYear.selectedIndex].value;//2006-12-01 ��www.ttkc.net�޸�
 ...
 var tds = this.getElementById("calendarTable").getElementsByTagName("td");
  ...
  tds[i].style.backgroundColor = calendar.colors["td_bg_out"];
    ...
    if(calendar.dateControl != null )
    {
      ...
      tds[i].style.cursor ="pointer"; //2007-08-06 ��www.ttkc.net��ӣ��������ָ״
...
Calendar.prototype.show = function (dateObj, popControl) {
  ...
  var now =  new Date();
  this.date = (dateObj.value.length > 0) ? new Date(dateObj.value.toDate(this.dateFormatStyle)) : now.format(this.dateFormatStyle).toDate(this.dateFormatStyle) ;//2008-01-29 www.ttkc.net��� �� ��Ϊ������dateFormatStyle��ʼ������
 ...
 this.bindSecond();
  ...
  this.panel.style.left = (xy.x + leftX)+ "px"; //��www.ttkc.net 2007-02-11 �޸� �� �����Զ���ƫ����
  this.panel.style.top = (xy.y + topY + dateObj.offsetHeight) + "px";
  
  //��www.ttkc.net 2006-06-25 �޸� �� �� visibility ��Ϊ display�������ʧȥ������¼�  //this.setDisplayStyle("select", "hidden");
...
//����ת��ʱ�������� �� ��www.ttkc.net 2006-06-25 ���
Calendar.prototype.onblur = function() {
    if(!isFocus){this.hide();}
}

//������www.ttkc.net 2007-07-26 �޸� �� ȷ�����������ڵ��� body ��󣬷��� FireFox �в��ܳ��������Ϸ�
