...
public class VPushCommands implements SqlBean {
...
sb.append(countRunned);
	...
	public Long getCountRunned() {
		return countRunned;
	}

	public void setCountRunned(Long countRunned) {
		this.countRunned = countRunned;
	}
}
