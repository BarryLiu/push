...
public class TableToJavaBean {
    ...
    public void tableToBean(Connection connection, String tableName) throws SQLException {
        ...
        sb.append(LINE);
//        sb.append("import com.push.admin.dbbean;");
        sb.append(LINE);
    ...
    private void implementsMethods(ResultSet rs,ResultSetMetaData md, int columnCount,String tableName, StringBuffer sb) {
    	...
    	sb.append("	private boolean canEdit=true;");
        sb.append(LINE);
    	sb.append("	public boolean isCanEdit() {");
        sb.append(LINE);
    	sb.append("		return canEdit;");
        sb.append(LINE);
    	sb.append("	}");
        sb.append(LINE);
    	sb.append("	public void setCanEdit(boolean canEdit) {");
        sb.append(LINE);
    	sb.append("		this.canEdit = canEdit;");
        sb.append(LINE);
    	sb.append("	}");
        sb.append(LINE);
...
//        if(true)return;
//        String jdbcString = "jdbc:sqlserver://192.168.1.11:3306; DatabaseName=project_manager";
//        Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
        String jdbcString = "jdbc:mysql://192.168.1.17:3306/push";
        Class.forName("com.mysql.jdbc.Driver");
        Connection con = DriverManager.getConnection(jdbcString, "root", "mysqlwiki");
