...
public class VbPushUpdateConfig implements SqlBean {
	@Override
	...
	public Integer getCountUpgraded() {
		return countUpgraded;
	}

	public void setCountUpgraded(Integer countUpgraded) {
