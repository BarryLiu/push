...
//	private static final String IP_FILE = IPSeeker.class.getResource("QQWry.dat").toString().substring(5);
	 ...
	 * ˽�й��캯��
	 */
	private IPSeeker(ServletContext servletContext) {
		...
		b3 = new byte[3];
		try {
			IP_FILE = servletContext.getRealPath("/") + "QQWry.dat";
	 ...
	 * @return ��һʵ��
	 */
	public static IPSeeker getInstance(ServletContext servletContext) {
		if(instance == null){
			instance = new IPSeeker(servletContext);
		}
		return instance;
	}
